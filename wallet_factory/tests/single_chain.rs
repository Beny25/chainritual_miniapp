...
//! Integration testing for the wallet_factory application.

#![cfg(not(target_arch = "wasm32"))]

use wallet_factory::Operation;
...
async fn single_chain_test() {
    let (validator, module_id) =
        TestValidator::with_current_module::<wallet_factory::WalletFactoryAbi, (), u64>().await;
